            ...
            <div class="card-body">
                <form action="{{ route('teacher.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="account" class="form-control" required oninvalid="setCustomValidity('請指定教師帳號')">
                        @if ($errors->has('msg'))
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-control" required oninvalid="setCustomValidity('請輸入教師姓名')">
                    </div>
                    <div class="form-group">
